...
<head>
  ...
  <!-- <script src="<?php echo base_url('/media/custom/js/bootstrap.min.js'); ?>"></script>
  <link href="<?php echo base_url('/media/custom/css/bootstrap.min.css'); ?>" rel="stylesheet"> -->
  <!-- Font Awesome -->
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?php echo base_url('/media/bower_components/morris.js/morris.css'); ?>">
  <!-- Select2 -->
  <link rel="stylesheet" href="<?php echo base_url('/media/bower_components/select2/dist/css/select2.min.css'); ?>">
  <!-- Date Picker -->  
  <link rel="stylesheet" href="<?php echo base_url('/media/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css'); ?>">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?php echo base_url('/media/bower_components/bootstrap-daterangepicker/daterangepicker.css'); ?>">
  <!-- iCheck for checkboxes and radio inputs -->
  <link rel="stylesheet" href="<?php echo base_url('/media/plugins/iCheck/all.css'); ?>">
  <!-- Bootstrap time Picker -->
  <link rel="stylesheet" href="<?php echo base_url('/media/plugins/timepicker/bootstrap-timepicker.min.css'); ?>">
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php echo site_url(''); ?>" class="logo">
        ...
        <span class="logo-mini"><b>O</b>SS</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>OSS</b>Admin</span>
      </a>
    ...
    <li class="dropdown user user-menu">
      <a href="#" class="dropdown-toggle" data-toggle="dropdown">
        ...
        <img 
          src="<?php $images = ucfirst($this->session->userdata('user_images_admin'));
            echo upload_url($images); ?>" 
          class="user-image" 
          alt="User Image">
        <span class="hidden-xs"><?php echo $text = ucfirst($this->session->userdata('user_full_name_admin')); ?></span>
      </a>
      <ul class="dropdown-menu">
        <!-- User image -->
        <li class="user-header">
          <img src="<?php $images = ucfirst($this->session->userdata('user_images_admin'));
            echo upload_url($images); ?>" class="img-circle" alt="User Image">

          <p>
            <font><?php echo $text = ucfirst($this->session->userdata('user_full_name_admin')); ?></font> <br>
            <font> <?php echo $text = ucfirst($this->session->userdata('user_departement_admin')); ?></font>
            <small>Member since <?php echo $text = ucfirst($this->session->userdata('employe_start_work_date_admin')); ?></small>
          </p>
        </li>
        <!-- Menu Body 
        <li class="user-body">
          <div class="row">
            ...
            <div class="col-xs-4 text-center">
              <a href="#">
                <?php echo $text = ucfirst($this->session->userdata('user_departement_admin')); ?> 
              </a>
            </div>
            <div class="col-xs-4 text-center">
              <a href="#">Friends</a>
        ...
        <li class="user-footer">
          ...
          <div class="pull-right">
            ...
            <button type="submit" class="btn btn-default btn-flat" role="button">Sign out</button>
            <?php echo form_close() ?>
          </div>
        </li>
      </ul>
...
<footer class="main-footer">
  ...
  <strong>Copyright &copy; 2017 <a href="http://RumahCG.com">Rumah Cipta Generasi</a>.</strong> All rights
  reserved.
</footer>
...
<!-- jQuery UI 1.11.4 -->
<script src="<?php echo base_url('/media/bower_components/jquery-ui/jquery-ui.min.js'); ?>"></script>
...
<!-- Morris.js charts -->
<script src="<?php echo base_url('/media/bower_components/raphael/raphael.min.js'); ?>"></script>
<script src="<?php echo base_url('/media/bower_components/morris.js/morris.min.js'); ?>"></script>
<!-- Sparkline -->
<script src="<?php echo base_url('/media/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js'); ?>"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="<?php echo base_url('/media/bower_components/jquery-knob/dist/jquery.knob.min.js'); ?>"></script>

<!-- daterangepicker -->
<script src="<?php echo base_url('/media/bower_components/moment/min/moment.min.js'); ?>"></script>
<script src="<?php echo base_url('/media/bower_components/bootstrap-daterangepicker/daterangepicker.js'); ?>"></script>
<!-- datepicker -->
...
<!-- bootstrap time picker -->
<script src="<?php echo base_url('/media/plugins/timepicker/bootstrap-timepicker.min.js'); ?>"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="<?php echo base_url('/media/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js'); ?>"></script>
<!-- iCheck 1.0.1 -->
...
<script src="<?php echo base_url('/media/bower_components/datatables.net/js/jquery.dataTables.js'); ?>"></script>
...
<!-- AdminLTE App -->
<script src="<?php echo base_url('/media/dist/js/adminlte.min.js'); ?>"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<?php echo base_url('/media/dist/js/pages/dashboard.js'); ?>"></script>
